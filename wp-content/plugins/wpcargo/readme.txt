...
* [SMS Notification](https://www.wpcargo.com/product/wpcargo-sms-add-ons/) -One Way SMS,Twilio, BULK SMS, BESTSMS.EU, SMS GATEWAY HUB, WEBSMS.GR, SmsGateWay24 
...
* [Shipping Rates with Woocommerce integration](https://www.wpcargo.com/product/wpcargo-shipping-rate/) -  Display rate and shipment costing per zone and weight and allow user to pay online using Woocommerce checkout 
* [Vehicle Rate Addons](https://www.wpcargo.com/product/vehicle-rate-add-on/)-  Display rates per  distance of the  origin and destinations and enable users to  book
* [POS](https://www.wpcargo.com/product/wpcargo-woocommerce-pos-add-on/)
* [Barcode Reader Status Update](https://www.wpcargo.com/product/wpcargo-receiver-add-ons/) - Update  status of your shipment  by scanning it  using barcode scanner 
* [Service API](https://www.wpcargo.com/product/wpcargo-api-addon/) - integrate  your site to other system using  API endpoints  
* [User Manager Addons ](https://www.wpcargo.com/product/wpcargo-api-addon/)- Add, Edit, Delete Users and access in front end manager, access permissions,
assigned default employee or driver to manage the shipment 
* [WPCargo Merchant Add on](https://www.wpcargo.com/product/wpcargo-merchant-add-on/) - Allow  store owner to import the order to the system  
* [WPCargo Invoice Addon](https://www.wpcargo.com/product/wpcargo-invoice-addon/) -  Automatic invoice generated once the shipment created . 
* [WPCargo Advance Invoice Addon](https://www.wpcargo.com/product/wpcargo-advance-invoice-addon/) - Manually  Invoice shipment or group of shipment into one invoice 
* [WPCargo Viber Notification Addons](https://www.wpcargo.com/product/wpcargo-viber-notification-addons/) -  Bot that  gives  shipping status using  Viber  
* [Driver Mobile App] - Android based app use to gather  photo and signature of the receiver   and update the shipment status 
