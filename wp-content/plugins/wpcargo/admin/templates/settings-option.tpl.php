        	...
        	<td>
        		<ul id="wpcargo_edit_history_role">
	        		...
	        		foreach ($roles as $role_key => $role_value) {
	        			?><li><input type="checkbox" name="wpcargo_option_settings[wpcargo_edit_history_role][]" value="<?php echo esc_html($role_key); ?>" <?php echo in_array( $role_key, $edit_history_role ) ? 'checked' : '' ; ?> /> <?php echo esc_html($role_value['name']); ?></li><?php
	        		}
	        		?>
	        	</ul>
        	</td>
