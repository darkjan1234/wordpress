...
class WPCargo{
	...
	*/
	...
	protected function prefix(){
	    ...
	    return apply_filters( 'wpcargo_prefix', esc_html( $prefix ) );
	}
	protected function suffix(){
		$suffix = get_option('wpcargo_title_suffix');
		return apply_filters( 'wpcargo_suffix', esc_html( $suffix ) );
	}
	...
	public function create_shipment_number(){
	    ...
	    $shipment_title = $this->prefix.$rand_number.$this->suffix;
