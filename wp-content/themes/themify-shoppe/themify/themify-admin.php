...
function themify_page() {
	...
	<!-- footer -->
	<div id="bottomtab">
	   <p id="logo"><a href="<?php echo themify_https_esc( 'https://themify.me/logs/framework-changelogs/' ); ?>" data-changelog="<?php echo themify_https_esc( 'https://themify.org/changelogs/themify.txt' ); ?>" target="_blank" rel="noopener" class="themify_changelogs">v<?php echo THEMIFY_VERSION; ?></a></p>
		<div class="reset">
...
function themify_maintenance_mode_settings() {
	...
	$output .= '<div data-show-if-element="[name=setting-page_builder_maintenance_mode]" data-show-if-value=\'["on", "message"]\'><label class="label">' . __( 'Who can access', 'themify' ) . '</label><div class="pushlabel">';
